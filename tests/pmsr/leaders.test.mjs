...
const data = {
  ...
  home: { abbr: 'AAA', xg: 1, totalDistanceKm: 100, physical: [
    { number: '1', name: 'Fast Guy', fifaId: 'A1', total_distance_m: 9000,
  ...
  away: { abbr: 'BBB', xg: 0, totalDistanceKm: 90, physical: [
    { number: '2', name: 'Runner', fifaId: 'B2', total_distance_m: 12000,
      zone1_0_7_m: 0, zone2_7_15_m: 0, zone3_15_20_m: 0, zone4_20_25_m: 0,
...
assert.equal(l.topSpeed.fifaId, 'A1');   // leaders now carry the FIFA player id
assert.equal(l.topSpeed.value, 35.0);
assert.equal(l.mostDistance.fifaId, 'B2');
assert.equal(l.mostSprints.fifaId, 'B2');
